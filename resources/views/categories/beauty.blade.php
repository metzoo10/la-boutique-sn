@extends('layout.main')
@section('title', 'La Boutique.sn votre boutique en ligne numéro 1 - Catégorie : Beauté')
@section('content')
	<!-- Page de la catégorie Beauté -->
	...
	<div class="container mt-5">
		<nav aria-label="breadcrumb">
	  		<ol class="breadcrumb">
	    		...
	    		<li class="breadcrumb-item active text-uppercase" aria-current="page">Beauté</li>
	  		</ol>
		</nav>
	</div>
	...
	<div class="container mt-5">
		<div class="d-flex justify-content-between align-items-center mb-4">
			<h3>Les produits de la catégorie : Beauté</h3>
			<div>
