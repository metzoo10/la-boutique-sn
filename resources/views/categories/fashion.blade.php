@extends('layout.main')
@section('title', 'La Boutique.sn votre boutique en ligne numéro 1 - Catégorie : Mode')
@section('content')
	<!-- Page de la catégorie Mode -->
	...
	<div class="container mt-5">
		<nav aria-label="breadcrumb">
	  		<ol class="breadcrumb">
	    		...
	    		<li class="breadcrumb-item active text-uppercase" aria-current="page">Mode</li>
	  		</ol>
		</nav>
	</div>
	...
	<div class="container mt-5">
		<div class="d-flex justify-content-between align-items-center mb-4">
			<h3>Les produits de la catégorie : Mode</h3>
			<div>
		...
		<div class="row">
			{{-- Boucle foreach pour afficher chaque produit de catégorie "Mode" --}}
			@foreach ($produitsMode as $produit)
