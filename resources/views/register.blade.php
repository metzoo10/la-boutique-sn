	...
	<div class="container mt-5 mb-5 border border-secondary py-4">
		...
		<form>
			<div class="mb-3">
				...
				<input type="text" class="form-control border-info" id="exampleInputName1" placeholder="Tapez votre prénom et nom">
			</div>
			<div class="mb-3">
				<label for="exampleInputEmail1" class="form-label fw-light mb-3">Adresse e-mail<span class="text-info">*</span></label>
				<input type="email" class="form-control border-info" id="exampleInputEmail1" placeholder="Tapez votre adresse e-mail" aria-describedby="emailHelp">
			...
			<div class="mb-3">
				...
				<input type="password" class="form-control border-info" id="exampleInputPassword1" placeholder="********" aria-describedby="passwordHelp">
